...
3. **Dashboard**: faça upsert no SQLite pela aplicação; leads novos entram como `novo` e descartados como `descartado`.

A entrega final deve confirmar quantos leads foram atualizados no painel e sugerir o próximo passo: redesenhar os melhores leads.
